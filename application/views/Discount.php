        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              ...
              <div><a href="<?= base_url('')?>">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Discount</span></div>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-6 col-lg-6">
                <ul class="list-unstyled">
                  ...
                  <li><a href="<?= base_url('Home/destinasi')?>">Destinasi</a></li>
